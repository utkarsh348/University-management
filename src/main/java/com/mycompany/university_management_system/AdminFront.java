...
public class AdminFront extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Change admission status");
        ...
        jLabel6.setText("Admission status");

        jLabel7.setText("-");

        jButton3.setText("Admit student");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            else if(adm == "admitted"){
                jLabel8.setText("Student already admitted");
            }
            else{
                jLabel8.setText("Student has not paid fee or been granted admission");
            }
        }
        catch(Exception e){
            System.out.println(e);
